...
import { SearchCollectionParams, SearchCompanyParams, SearchKeywordParams, SearchMovieParams, SearchMultiParams, SearchPersonParams } from "../../__generated__/schema";

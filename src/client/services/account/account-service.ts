...
import { AccountAddFavoriteBody, AccountAddFavoriteParams, AccountAddToWatchlistBody, AccountAddToWatchlistParams, AccountDetailsParams, AccountFavoriteTvParams, AccountGetFavoritesParams, AccountListsParams, AccountRatedMoviesParams, AccountRatedTvEpisodesParams, AccountRatedTvParams, AccountWatchlistMoviesParams, AccountWatchlistTvParams } from "../../__generated__/schema";
...
export default class AccountService {
    ...
    public async addFavorite(accountId: number,
        accountAddFavoriteBody: AccountAddFavoriteBody,
        params?: AccountAddFavoriteParams) {
        return await orval.accountAddFavorite(accountId, accountAddFavoriteBody, params, this.defaultOptions);
    }

    public async addToWatchlist(accountId: number,
        accountAddToWatchlistBody: AccountAddToWatchlistBody,
        params?: AccountAddToWatchlistParams) {
        return await orval.accountAddToWatchlist(accountId, accountAddToWatchlistBody, params, this.defaultOptions);
    }

...
export default class TVService {
    ...
    public async tvSeriesChanges(seriesId: number,
    ...
    public async tvSeriesCredits(seriesId: number,
    ...
    public async getSimilar(seriesId: string,
    ...
    public async addRating(seriesId: number,
        ...
        return await orval.tvSeriesAddRating(seriesId,tvSeriesAddRatingBody, params, this.defaultOptions);
    }

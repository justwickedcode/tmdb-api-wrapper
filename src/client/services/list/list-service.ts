...
import { ListAddMovieBody, ListAddMovieParams, ListCheckItemStatusParams, ListClearParams, ListCreateBody, ListCreateParams, ListDeleteParams, ListDetailsParams, ListRemoveMovieBody, ListRemoveMovieParams } from "../../__generated__/schema";
import { CustomRequestInit } from "../../types";

export default class ListService {
    constructor(private readonly defaultOptions: CustomRequestInit) {}

    public async addMovie(listId: number,
